...
requestOptions = require './index'

module.exports = streamSpec(requestOptions)
  
  .case 'requestOptions generates request options'
  ...
  .case 'requestOptions generates request options (alternate)'
